module.exports = [{
    ...
    "year": 2012,
    "month": 11,
    "thumb_url": "geo_game_thumb.jpg",
    "image_urls": [
        "geo_game_leaderboard.jpg",
        "geo_game_admin.jpg"
    ]
},{
    ...
    "description": "I volunteered to design and build a web app for an internal initiative to raise money for the JDRF. The site is responsive, using a PHP/Mysql backend to store pledge data. I built the pledge thermometer widget entirely from CSS and custom data binding.",
    "tools": [
        "CSS",
        "HTML5",
        "Javascript",
    ...
    "year": 2014,
    "thumb_url": "fundraiser_thumb.png",
    "image_urls": [
        "fundraiser.png"
    ]
},{
    ...
    "description": "I provided many clients with front-end code for TMP's job search recruitment web product. Work was based on a boilerplate and tailored to meet the needs of the client.",
    "tools": [
        "CSS",
        "HTML5",
        "Javascript"
    ...
    "year": 2014,
    "thumb_url": "job_candidate_thumb.jpg",
    "image_urls": [
        "job_candidate.jpg"
    ]
},{
    ...
    "thumb_url": "company_admin_thumb.png",
    "image_urls": [
        "company_admin.png"
    ],
    "work_types": [
